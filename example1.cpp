...
"big_spider.ply", "canstick.ply", "chopper.ply", "cow.ply", "happy.ply", "egret.ply", "f16.ply", "footbones.ply", "fracttree.ply",
...
int isnormalmode, isbreathmode, iscuboidmode, iscuboidmodeextend,isshearmode;
...
void displayhw2(void)
{
	...
	Angel::mat4 perspectiveMat = Angel::Perspective((GLfloat)45.0, (GLfloat)width / (GLfloat)height, (GLfloat)0.1, (GLfloat) 100.0); //mat4?Angel????
